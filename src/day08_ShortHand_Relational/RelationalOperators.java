...
public class RelationalOperators {
    public static void main(String[] args) {
       ...
       boolean r4 = num2 < num1;
        ...
        System.out.println( 10 > 9);//10 is greater than 9; true
        System.out.println( 10 < 9);// 10 is less than 9; false
