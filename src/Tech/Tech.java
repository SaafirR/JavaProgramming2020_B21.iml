...
public class Tech {
    ...
    public static void main(String[] args) {
        ...
        if (b == false){
            ...
            System.out.println("That's awesome, nice to meet you " + name + ".");
            ...
            System.out.println("2. What is the address to the White House?");
            System.out.println();
            System.out.print("Is there anything else from this list above that I can assist you with? Please ENTER a number:" );
