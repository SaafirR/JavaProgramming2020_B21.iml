...
public class AgeGroups {
    ...
    public static void main(String[] args) {
        ...
        if (age >= 1 && age <= 2) {
            ageGroups = "infant";
        } else if (age >= 3 && age <= 5) { //<= 5, becomes false when age >= 6
            ageGroups = "Toddler";
        } else if (age <= 6 && age <= 9) { // age <= 9, becomes false when age is >= 10
            ageGroups = "Kid";
        } else if (age >= 10 && age <= 12) { // age <=12, becomes false when age is >= 13
            ageGroups = "Pre - Teen";
        } else if (age <= 13 && age <= 17) {// age <= 17, becomes false when age >= 18
            ageGroups = "Teenager";
        } else if (age <= 18 && age <= 20) { // age <= 20, becomes false when age is >= 21
        ...
        } else if (age <= 65 && age <= 74) {// age <= 74, becomes false when age >= 74
